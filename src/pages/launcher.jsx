...
import {
    ...
    Box, Settings, Search, Bell, Star, Grid
} from 'lucide-react';
...
const apps = [
    ...
    { id: 'transactions', name: 'Transactions', icon: ArrowLeftRight, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-500/10', path: '/transactions' },
    { id: 'expenses', name: 'Expenses', icon: TrendingDown, color: 'text-rose-500', bg: 'bg-rose-50 dark:bg-rose-500/10', path: '/transactions' },
    { id: 'income', name: 'Income', icon: TrendingUp, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-500/10', path: '/transactions' },
    ...
    { id: 'taxes', name: 'Taxes', icon: Landmark, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-500/10' },
    { id: 'assets', name: 'Assets', icon: Box, color: 'text-slate-500', bg: 'bg-slate-50 dark:bg-slate-500/10' },
...
const AppLauncher = () => {
    ...
    React.useEffect(() => {
        const checkRole = async () => {
            ...
            if (user?.email === 'superadmin@example.com' || user?.user_metadata?.role === 'superadmin') {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 lg:p-12 animate-in fade-in duration-700">
            ...
            <div className="max-w-7x mx-auto grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                {apps.map((app) => (
                    <div
                        key={app.id}
